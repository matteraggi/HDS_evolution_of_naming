...
PIPELINE = [
    "00b_scrape_movie_dataset.py",
    "00c_scrape_music_dataset.py",
    "00d_scrape_sports_dataset.py",
    "01_process_ssa.py",
    "01b_process_istat_contanomi.py",
    "01c_check_coverage_bias.py",
    "01d_check_cosine_bias.py",
    "01e_process_gender_neutral.py",
    "01f_plot_gender_neutral.py",
    "02_mann_kendall_us.py",
    "03_us_italy_comparison.py",
    "06_find_us_spikes.py",
    "07_find_it_spikes.py",
    "07b_event_study_movies.py",
    "07c_plot_movie_event_study.py",
    "07d_event_study_music.py",
    "07e_plot_music_event_study.py",
    "07f_event_study_sports.py",
    "07g_plot_sports_event_study.py",
    "07h_cross_category_event_study.py",
