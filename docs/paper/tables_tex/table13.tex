...
Copertura della distribuzione & Completa (tutti i nomi con >=5 nascite/anno/stato/sesso) & Variabile 66-100\% delle nascite a seconda dell'anno (Tabella 14 dimostra che questo non introduce distorsione nella metrica di concentrazione primi-10/50, mentre l'entropia resta attendibile solo per il 2022-2024) \\
...
Implicazione per l'analisi & Permette entropia di Shannon completa e rilevamento di spike su tutta la distribuzione & Permette la quota di concentrazione primi-10/50 su tutta la finestra 1999-2024 e il rilevamento di spike sui nomi effettivamente catturati ogni anno (minimo comunque ben oltre la top-50); l'entropia completa resta limitata al 2022-2024 \\
