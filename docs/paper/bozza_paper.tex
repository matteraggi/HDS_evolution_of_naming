...
per il 2024 (Leonardo: 6.580 nascite, Sofia: 4.636; quota primi-50 maschile: 53,28\%) sono stati
...
percentuale tra le due. Questa variazione viene confrontata con quella di un \textbf{gruppo di
...
periodo. L'\textbf{impatto netto DiD} (Difference-in-Differences) è la differenza fra la variazione del
nome esposto e quella mediana dei controlli: isola l'effetto specifico dell'evento dal trend di fondo
che il nome avrebbe comunque seguito. La significatività è testata con Wilcoxon per ranghi con segno
