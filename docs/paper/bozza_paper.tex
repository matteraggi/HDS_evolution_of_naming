...
quattro i casi sesso/soglia). Detto in altri termini: non c'è stato un solo anno, in un quarto di
...
onestamente invece di appiattirlo su una sola narrazione. Ai primi 10 nomi le pendenze di Sen sono
statisticamente indistinguibili (USA $-0{,}0020$/anno, Italia $-0{,}0023$/anno, intervalli
sovrapposti, serie differenza senza trend significativo, $p = 0{,}078$): il divario appare stabile. Ai
...
starebbe leggermente allargandosi. Il risultato femminile è quindi robusto rispetto alla scelta della
...
Va segnalato un limite di questo controllo, evidenziato in Figura~\ref{fig:state_concentration}: un
...
nitidamente. Il 100\% di concordanza su un campione così piccolo va quindi letto con più cautela del
...
genitori. Un genitore può scegliere un nome raro per motivi che nulla hanno a che fare con la ricerca
...
di esaustività. Il primo è demografico: gli Stati Uniti hanno un tasso di immigrazione storicamente
...
in uso. Il secondo è una convenzione culturale specifica: in Italia esiste una tradizione,
...
un equivalente altrettanto diffuso negli Stati Uniti. Il terzo è l'istruzione: alcuni studi collegano
...
usati qui non permettano di verificarlo direttamente. Infine, la globalizzazione dei media, già
...
maschili, come mostrato dal test sulla serie differenza (Sezione~\ref{sec:risultati}). Nessuno di
