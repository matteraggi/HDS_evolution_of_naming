...
\and
\IEEEauthorblockN{Matteo [DA COMPLETARE -- cognome]}
\IEEEauthorblockA{Alma Mater Studiorum -- Università di Bologna}
}
...
($H_0$/$H_1$/$\alpha = 0{,}05$ dichiarati) e \textbf{controlli di robustezza/sensibilità}, che non
...
Il \textbf{controllo di robustezza alla profondità di copertura} (troncamento artificiale dei due anni
...
no.~3, pp.~163--171, 1945.

\bibitem{kendall1975} M.~G. Kendall, \emph{Rank Correlation Methods}. London: Charles Griffin, 1975.
...
Change}. New Haven: Yale University Press, 2000.
...
Personality Science}, vol.~1, no.~1, pp.~19--25, 2010.

\bibitem{twenge2016} J.~M. Twenge et al., ``Still Standing Out: Children's Names in the United States
During the Great Recession and Correlations with Economic Indicators,'' \emph{Journal of Applied
...
Hemisphere (1500-2000),'' \emph{Current Research in Ecological and Social Psychology}, 2025.

\bibitem{ons2015} UK Office for National Statistics, ``10 Pop Culture Influences on Baby Names,''
2015.
